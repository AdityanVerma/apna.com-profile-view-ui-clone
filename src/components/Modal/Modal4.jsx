            ...
            <div className="content-section pb0">
              <div className="flex modal-content-inside">
                ...
                <form className="entry-form">
                  ...
                  <div className="form-group">
                    <label className="modal-heading" htmlFor="specialisation">Education Type</label>
                    <form action="" className="flex selection">
                      <input type="radio" id="fullTime" name="education-type" value="Full-Time" />
                      <label htmlFor="fullTime">Full-Time</label>

                      <input type="radio" id="partTime" name="education-type" value="Part-Time" />
                      <label htmlFor="partTime">Part-Time</label>

                      <input type="radio" id="correspondence" name="education-type" value="Correspondence" />
